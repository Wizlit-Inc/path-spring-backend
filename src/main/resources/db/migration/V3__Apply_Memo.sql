...
CREATE TABLE IF NOT EXISTS memo (
    ...
    memo_title               VARCHAR(300)  NOT NULL,
    ...
    memo_alt_content         TEXT
);
CREATE INDEX IF NOT EXISTS idx_memo_point ON memo(memo_point);

-- Create memo_contributor junction table
CREATE TABLE IF NOT EXISTS memo_contributor (
    memo_id BIGINT NOT NULL REFERENCES memo(memo_id) ON DELETE CASCADE,
    user_id BIGINT NOT NULL REFERENCES path_user(user_id) ON DELETE CASCADE,
...
SELECT
    ...
    'GOOGLE_DOCS'                        AS memo_type,
    p.document                           AS memo_alt_content,
